...
INTRO_MSG = (
    ...
    "\n"
    "¿Qué puedo hacer?\n"
    "📋 *Boletín Oficial* — reviso cada hora y te aviso si hay algo con tus palabras clave.\n"
    "🖥️ *SysInfo* — `/sysinfo` para ver estado del bot y sistema.\n"
    "🧮 *Calculadora* — `/calc 2+2*3` para matemáticas rápidas.\n"
    "🔍 *Scraping* — `/watch <url>` para monitorear una URL.\n"
...
HELP_MSG = (
    ...
    "\n"
    "*Boletín Oficial* 📋\n"
    "• /boletin — Status del boletín (automático cada 60 min)\n"
    "• /go — Scrapea Boletín 1ra de hoy (manual)\n"
    ...
    "• /boletin\\_check — Forzar check manual\n"
    "\n"
    "💡 *Tip:* El bot checkea automáticamente cada hora y envía solo cosas nuevas."
)
